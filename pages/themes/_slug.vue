<template>
  <div>
    ...
    <article class="container mx-auto px-5 py-4" >
      <nuxt-content id="main" class="font-serif prose prose-midnight max-w-[52rem] mx-auto mt-4 2xl:max-w-[68rem] prose-h1:text-xl prose-h1:xl:text-4xl prose-h2:text-lg prose-h2:xl:text-3xl prose-h3:text-base prose-h3:xl:text-2xl prose-h4:text-base prose-h4:xl:text-2xl prose-h5:text-base prose-h5:xl:text-2xl prose-h6:text-base prose-h6:xl:text-2xl prose-p:xl:text-xl prose-ul:xl:text-xl prose-ol:xl:text-xl" :document="page" />
      <div
      v-if="page.objects"
      id="resources"
      >
